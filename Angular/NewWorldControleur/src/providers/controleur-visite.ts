...
/*
  Generated class for the ControleurVisite provider.
...
export class ControleurVisite {
	...
	//jsonApiUrl = 'http://10.0.2.2/~jkappler/MDB Free/json/visite.php';
	jsonApiUrl = 'http://172.29.56.8/~jkappler/MDB Free/json/visite.php';
